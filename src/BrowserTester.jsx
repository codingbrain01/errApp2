            ...
            {stage === 1 && (
                ...
                >
                    <div className="bg-white rounded-xl shadow-2xl overflow-hidden max-w-md w-full relative p-8 text-center">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Google Security Alert</h2>
                        <p className="text-gray-600 mb-6">Unusual activity detected. Please verify your identity to continue.</p>
